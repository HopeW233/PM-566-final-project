...
fig4 <- dat %>%
  ...
  geom_vline(aes(xintercept=as.numeric(ymd("2020-06-19"))), linetype = "dashed", color = "darkred", size = 0.5, text = "wear a mask")+ ##wear a mask
  geom_vline(aes(xintercept=as.numeric(ymd("2020-07-13"))), linetype = "dashed", color = "darkred", size = 0.5, text = "wear a mask")+ ##ordering all bars and indoor dining at restaurants statewide to close
...
cv_ca %>%
  mutate(positiveRate = positive/totalTestResults) %>%
  ggplot()+
  geom_point(aes(date, positiveRate))+
  geom_vline(aes(xintercept=as.numeric(ymd("2020-06-19"))), linetype = "dashed", color = "darkred", size = 0.5, text = "wear a mask")+ ##wear a mask
  geom_vline(aes(xintercept=as.numeric(ymd("2020-07-13"))), linetype = "dashed", color = "darkred", size = 0.5, text = "wear a mask")+ ##ordering all bars and indoor dining at restaurants statewide to close
  ggtitle("New cases in California by month")+
  theme_classic()
