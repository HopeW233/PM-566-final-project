...
This is my PM566 Final Project, you can access the full report [here]()
...
fig4 <- dat_policy %>%
  ...
  annotate(geom = "rect", xmin = ymd(min(dat_policy$date)), xmax = ymd("2020-03-19"), ymin =0, ymax = 15000, fill = "blue", alpha = 0.2)+
  annotate("text", x = ymd("2020-02-15"), y = 7000, label = "loose")+
  annotate(geom = "rect", xmin = ymd("2020-03-19"), xmax = ymd("2020-05-25"), ymin =0, ymax = 15000, fill = "red", alpha = 0.2)+
  annotate("text", x = ymd("2020-04-20"), y = 7000, label = "first order")+
  annotate(geom = "rect", xmin = ymd("2020-05-25"), xmax = ymd("2020-07-13"), ymin =0, ymax = 15000, fill = "blue", alpha = 0.2)+
  annotate("text", x = ymd("2020-06-15"), y = 7000, label = "loose")+
  annotate(geom = "rect", xmin = ymd("2020-07-13"), xmax = ymd("2020-09-22"), ymin =0, ymax = 15000, fill = "red", alpha = 0.2)+
  annotate("text", x = ymd("2020-08-15"), y = 7000, label = "statewide order")+
  annotate(geom = "rect", xmin = ymd("2020-09-22"), xmax = ymd("2020-11-21"), ymin =0, ymax = 15000, fill = "blue", alpha = 0.2)+
  annotate("text", x = ymd("2020-10-20"), y = 7000, label = "loose")+
  annotate(geom = "rect", xmin = ymd("2020-11-21"), xmax = ymd(max(dat_policy$date)), ymin =0, ymax = 15000, fill = "red", alpha = 0.2)+
